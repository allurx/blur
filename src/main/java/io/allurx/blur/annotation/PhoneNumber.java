...
import io.allurx.blur.handler.PhoneNumberHandler;
...
/**
 * Annotation for marking phone numbers as sensitive.
 * The default blurring rule masks all characters except for the first three
 * and the last four.
 *
 * @author allurx
 */
...
public @interface PhoneNumber {
     ...
     *
     * @return The starting position to blur, defaults to 3.
     */
