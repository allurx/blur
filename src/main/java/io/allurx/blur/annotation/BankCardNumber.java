...
import io.allurx.blur.handler.BankCardNumberHandler;
...
/**
 * Annotation for marking bank card numbers as sensitive.
 * The default blurring rule masks all characters except for the last four.
 *
 * @author allurx
 */
